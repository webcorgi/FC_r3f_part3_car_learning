...
export function RoadSign({position}) {
  ...
  return (
    <group ref={ref}>
      <mesh scale={0.2} position={[0,-0.48, 0]} geometry={nodes.Object_1.geometry} material={materials['WoodLight.001']} />
      ...
      >
        <mesh geometry={nodes.Object_1_1.geometry} material={materials.Wood} />
